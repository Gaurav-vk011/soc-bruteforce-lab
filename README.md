...
> **Role:** SOC Analyst L1 (Simulated Lab Environment)  
...
├── screenshots/
│   ├── splunk_detection_query.png     # SPL query + detection result
│   ├── splunk_attack_timeline.png     # Full attack timeline in Splunk
│   └── abuseipdb_lookup.png           # IOC reputation check result
└── report/
...
The complete incident investigation report (PDF) is available in the `report/` folder. It includes:
- Executive summary
